...
@section('content')
    <div class="container" id="editAirport">
        ...
        <div class="row">
            <div class="row justify-content-center" style="margin-top: 100px;">
                    <div class="col-6 p-5 shadow">
                        <h2 class="pb-3">Редактирование аэропорта</h2>
    
                        <form id="form_edit_airport" @submit.prevent="editAirport({{ $airport->id }})">
                            <div class="mb-3">
                                <label for="title" class="form-label">Название аэропорта</label>
                                <input type="text" class="form-control" id="title" name="title" :class="errors.title ? 'is-invalid':''" value="{{ $airport->title }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address" name="address" :class="errors.address ? 'is-invalid':''" value="{{ $airport->address }}">
    ...
    <script>
        const app = {
            ...
            methods: {
                ...
                async editAirport(id) {
                    let form = document.getElementById('form_edit_airport');
                    ...
                    if (response.status == 200) {
                        ...
                        window.location = '{{ route('show_all_airports') }}';
                    }
                }
            }, 
            mounted() {
        ...
        Vue.createApp(app).mount('#editAirport');
    </script>
@endsection