...
@section('content')
    <div class="container my-5" id="registration">
        ...
        <div class="row">
            <div class="col-12 d-flex shadow p-0" style="margin-top: 100px;">
                <div class="col-4">
                    <img src="{{ asset('public\img\reg_img.jpg') }}" alt="" style="height: 100%;">
                </div>
                <div class="col-8 p-5">
                    <h2 class="pb-3">Регистрация</h2>

                    <form id="form_reg" @submit.prevent="Reg">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 form-check">
                            ...
                            <label class="form-check-label" for="rule">Согласие с правилами регистрации</label>
                        </div>
